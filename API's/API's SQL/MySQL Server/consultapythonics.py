...
while True:
    ...
    select = meucursor.execute("SELECT column_name FROM information_schema.columns WHERE  table_name = 'dataset_comp2' AND table_schema = 'projetoapi'")
    ...
    mycursor.execute("select {} from dataset_comp2 limit {}".format(a,b))
