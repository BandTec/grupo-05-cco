...
(null, 'Kalil Bego', 'Rua Barreiro', 'Carapicuíba', 'São Paulo', '2020-12-20', 'Kalilmito@gmail.com', 'senha', '22.00°C', '50%', 1),
(null, 'Kaio Katiau', 'Rua Camarelo', 'Osasco', 'São Paulo', '2002-02-01', 'Kaiosilva@gmail.com', 'katiau', '20.00°C', '20%', 3),
(null, 'Eric Viezzer', 'Rua Jacinto Neves', 'Parati', 'Rio de Janeiro', '2010-10-03', 'Capivara@gmail.com', 'Capivara', '15.00°C', '70%', 1),
(null, 'Victor Barbosa', 'Rua Bacalhau', 'Butão', 'Goiana', '2030-09-01', 'Victor@gmail.com', 'senha', '25.00°C', '50%', 2),
(null, 'Gabriel Marcolino', 'Rua Nada', 'Piauzinho', 'Sergipe', '2005-03-15', 'Marcoli@gmail.com', 'senha', '30.00°C', '30%', 2);
...
(1, 2, '12:00', '2020-12-03', '30%', '23.00°C'),
(1, 3, '18:00', '2020-12-04', '25%', '23.00°C'),
(2, 1, '06:00', '2020-05-02', '30%', '24.00°C'),
(2, 2, '12:00', '2020-05-03', '50%', '21.00°C'),
(2, 3, '18:00', '2020-05-04', '45%', '30.00°C'),
(3, 1, '06:00', '2020-01-01', '50%', '32.00°C'),
(3, 2, '12:00', '2020-01-02', '50%', '29.00°C'),
(3, 3, '18:00', '2020-01-03', '60%', '30.00°C');
...
select * from cliente,eventos where idCliente = 1 and temperatura = '22.00°C'; -- mostra os dados do cliente 1 e os eventos que correspondem a sua temperatura ideal
